export interface SessionProfile { id: string; nickname: string | null; createdAt: string; serverNow: string }
...
export interface RoomDetail extends RoomSummary { version: number; players: RoomPlayer[]; viewerSessionId: string; viewerIsMember: boolean; viewerIsHost: boolean }
